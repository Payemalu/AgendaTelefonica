using AgendaTelefonica_Prueba.Models;
...
namespace AgendaTelefonica_Prueba.Controllers
{
    ...
    public class PersonasController : Controller
    {
        ...
        public IEnumerable<Persona> GetPersonas()
        {
            ...
            //{
            //    new Persona(){Id = 1, Nombre = "Juan Carlos Cuéllar Ruz", FechaNacimiento = new DateTime(1972, 19, 11)},
            //    new Persona(){Id = 2, Nombre = "Beatriz Chávez", FechaNacimiento = new DateTime(1973, 20, 09)}
            //};
